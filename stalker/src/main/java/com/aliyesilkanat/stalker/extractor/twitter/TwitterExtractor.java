...
public class TwitterExtractor extends Extractor {
	...
	public String execute() {
		...
		JsonArray convertJsonIntoJsonLd = convertJsonIntoJsonLd();

		getLogger().info("Json elements in JsonArray converted into jsonLDs");
		return convertJsonIntoJsonLd.toString();

	}

	private JsonArray convertJsonIntoJsonLd() {
	...
	private JsonObject createLDObject(String username, String name,
			String profilePic) {
